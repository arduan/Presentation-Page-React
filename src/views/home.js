  ...
  return (
    <div className={styles['container']}>
      ...
      <div className={styles['Navbar-container']}>
        <div className={styles['Navbar']}>
          ...
          <div className={styles['Links-container']}>
            <a
              href="#features"
              className={` ${styles['Link']} ${projectStyles['anchor']} ${projectStyles['thqLink']} `}
            >
              features
            </a>
            <a
              href="#services"
              className={` ${styles['Link1']} ${projectStyles['anchor']} ${projectStyles['thqLink']} `}
            >
              services
            </a>
            <a
              href="#about-us"
              className={` ${styles['Link2']} ${projectStyles['anchor']} ${projectStyles['thqLink']} `}
            >
              About Us
            </a>
            <a
              href="#contact"
              className={` ${styles['Link3']} ${projectStyles['anchor']} ${projectStyles['thqLink']} `}
            >
              contact
            </a>
          </div>
      ...
      <div className={styles['Hero']}>
        ...
        <img
          alt="image"
          src="/playground_assets/%D0%B8%D0%B2%D0%B0%D0%BD%D0%BE%D0%B2-1000w.gif"
      ...
      <div id="features" className={styles['Features']}>
        <div className={styles['Heading-container']}>
          ...
          <span
            className={` ${styles['Text05']} ${projectStyles['section-Text']} `}
          >
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec
      ...
      <div id="services" className={styles['Services']}>
        <div className={styles['Service-card']}>
          <div className={styles['Card-content']}>
            <h3
              className={` ${styles['text09']} ${projectStyles['bigCard-Heading']} `}
            >
              Service name
            </h3>
            <span
            ...
            <button
              className={` ${styles['button']} ${projectStyles['button']} ${projectStyles['anchor']} `}
            >
              READ MORE
            </button>
          </div>
        ...
        <div className={styles['Service-card1']}>
          <div className={styles['Card-content1']}>
            <h3
              className={` ${styles['text11']} ${projectStyles['bigCard-Heading']} `}
            >
              Service name
            </h3>
            <span
            ...
            <button
              className={` ${styles['button1']} ${projectStyles['button']} ${projectStyles['anchor']} `}
            >
              READ MORE
            </button>
          </div>
        ...
        <div className={styles['Service-card2']}>
          <div className={styles['Card-content2']}>
            <h3
              className={` ${styles['text13']} ${projectStyles['bigCard-Heading']} `}
            >
              Service name
            </h3>
            <span
        ...
        <div className={styles['Service-card3']}>
          <div className={styles['Card-content3']}>
            <h3
              className={` ${styles['text15']} ${projectStyles['bigCard-Heading']} `}
            >
              Service name
            </h3>
            <span
            ...
            <button
              className={` ${styles['button3']} ${projectStyles['button']} ${projectStyles['anchor']} `}
            >
              READ MORE
            </button>
          </div>
      ...
      <div id="about-us" className={styles['About-us']}>
        <div className={styles['Heading-container1']}>
          <h2
            className={` ${styles['text17']} ${projectStyles['section-Heading']} `}
          >
            What&apos;s the story behind our product?
          </h2>
          <span
            className={` ${styles['secondary-text']} ${projectStyles['section-Text']} `}
          >
            {' '}
          ...
          <button
            className={` ${styles['cta-btn2']} ${projectStyles['button']} ${projectStyles['anchor']} `}
          >
            START BUILDING
          </button>
        </div>
        <div className={styles['Text-container']}>
          <span
            className={` ${styles['text18']} ${projectStyles['section-Text']} `}
          >
        ...
        <button
          className={` ${styles['cta-btn3']} ${projectStyles['button']} ${projectStyles['anchor']} `}
        >
          START BUILDING
        </button>
      </div>
      ...
      <div id="contact" className={styles['Contact']}>
        <div className={styles['Content-container']}>
          <h2
            className={` ${styles['text24']} ${projectStyles['section-Heading']} `}
          >
            This is where to find us
          </h2>
          <div className={styles['Locations-container']}>
            <div className={styles['Location-1']}>
              <span className={styles['Heading4']}>London Office</span>
            ...
            <div className={styles['Location-2']}>
              <span className={styles['Heading5']}>New York Office</span>
              <div className={styles['Adress1']}>
